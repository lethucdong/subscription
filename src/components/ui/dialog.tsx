  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-2xl border border-white/[0.1] bg-gray-950 shadow-2xl",
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-lg p-1 text-gray-500 hover:text-gray-300 hover:bg-white/[0.06] transition-colors focus:outline-none">
        <X className="h-4 w-4" />
